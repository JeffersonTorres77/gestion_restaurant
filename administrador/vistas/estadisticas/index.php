<div class="m-2 p-2">
    <div class="card">
        <div class="card-header">
            <h5 class="m-0">Pedidos por platos</h5>
        </div>
                                    ...
                                    <div class="input-group input-group-sm mb-2">
                                        ...
                                        <select class="form-control" name="nombre">
                                            ...
                                            <?php
                                                ...
                                                {
                                                    ?>
                                                        <option value="<?php echo $restaurant['idRestaurant']; ?>">
                                                            <?php echo $restaurant['nombre']; ?>
                                                        </option>
                                                    <?php
                                                }
                                            ?>
            ...
            <div id="tabla">
                <div class="table-responsive">
                    <table class="table table-hover table-striped table-bordered m-0 table-sm">
                        <thead>
                            <tr>
                                <th ordenar="true" key="nombre" class="w-auto">Restaurant</th>
