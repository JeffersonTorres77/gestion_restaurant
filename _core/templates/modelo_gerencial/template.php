    ...
    public static function Iniciar()
    {
        ?>
            ...
            <head>
                ...
                <link rel="stylesheet" href="<?php echo HOST."recursos/gerencial/css/template.css?v=".SISTEMA_VERSION; ?>">
                <script defer src="<?php echo HOST."recursos/gerencial/js/template.js?v=".SISTEMA_VERSION; ?>"></script>
